...
async function callProcedure(procedureName: string, params: any[] = []): Promise<RowDataPacket[]> {
  ...
  try {
    ...
    const [result]: [RowDataPacket[], FieldPacket[]] = await connection.query(query, params);
