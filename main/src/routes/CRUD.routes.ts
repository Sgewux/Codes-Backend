...
router.get("/problems/problemsetter/:handle", async (req: Request, res: Response) => {
...
router.post("/problems/problemsetter/", async (req: Request, res: Response) => {
...
router.put("/problems/problemsetter/:id", async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.delete("/problems/problemsetter/:id", async (req: Request, res: Response) => {
  const { id } = req.params;
  try {
